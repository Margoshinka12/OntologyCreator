...
namespace OntologyCreator.Forms
{
    public partial class Welcome : Form
    {
        ...
        {
            MessageBox.Show("Программное средство для поддержки интервьюирования экспертов для создания и поддержания онтологий.\nКурсовая работа студентки ПМИ-2-20 Калининой Маргариты (3 курс).\n" +
                ...
                " При этом пользователям необязательно иметь познания и навыки в инженерии знаний, так как процесс создания онтологии происходит путём интервьюрования." +
